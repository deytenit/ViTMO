<template>
  <header>
    ...
    <div class="languages">
      <a href="#"
        ><img class="flag" src="../assets/img/gb.png" alt="In English" title="In English"
      /></a>
      <a href="#"
        ><img class="flag" src="../assets/img/ru.png" alt="In Russian" title="In Russian"
      /></a>
    </div>
    ...
    <nav>
      <ul>
        ...
        <li><a v-if="user" href="#" @click.prevent="changePage('Write')">Write</a></li>
      </ul>
    </nav>
  </header>
</template>
