...
TEST_P(ConvertingTestsSuite, EqualTest) {
    uint2022_t a(std::get<0>(GetParam()));
    uint2022_t b(std::get<1>(GetParam()));
...
TEST_P(OperationTestsSuite, AddTest) {
    ...
    uint2022_t expected(std::get<2>(GetParam()));
...
TEST_P(OperationTestsSuite, SubstTest) {
    ...
    uint2022_t result = a - b;
    uint2022_t expected(std::get<3>(GetParam()));
...
TEST_P(OperationTestsSuite, MultTest) {
    ...
    uint2022_t result = a * b;
    uint2022_t expected(std::get<4>(GetParam()));
